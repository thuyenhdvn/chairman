...
$_SESSION["preset"] = 1;
/**
 * Template Name: Demo Furniture 1
 *
										...
										<div class="global-row">
											<div class="global-cell">
												<?php if( isset($chairman_opt['logo_main']['url']) ){ ?>
													<div class="logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo get_template_directory_uri() . '/images/furniture1_logo.png'; ?>" alt="<?php bloginfo( 'name' ); ?>" /></a></div>
												<?php
												} else { ?>
